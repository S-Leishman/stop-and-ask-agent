...
1. **Problem (0:00–0:35):** Introduce **VetProof, powered by Tiny Verdicts**.
   Agents can do useful work autonomously, but a
...
4. **Tiny Verdict + stop boundary (2:05–3:00):** Show `UNKNOWN`,
   `HUMAN_DECISION_REQUIRED`, the proposed
